...
export const assessmentConfig: AssessmentConfig = {
  ...
  opening: {
    headline: '你目前的形象，與希望留給他人的印象一致嗎？',
    supportingText: '由 Martin 親自提出四項簡單問題，了解你目前最值得改善的方向。',
    cta: '開始形象檢測',
  ...
  results: {
    untapped_image_potential: {
      ...
      eyebrow: '你的初步形象分析',
      title: '未被發揮的形象潛力',
      summary: '你已清楚希望作出改變，只是仍缺乏一套清晰而可持續執行的方法。',
    ...
    professional_presence_gap: {
      ...
      eyebrow: '你的初步形象分析',
      title: '專業存在感落差',
      summary: '你希望呈現成熟可靠的形象，但目前造型尚未完全配合職場角色。',
    ...
    style_without_structure: {
      ...
      eyebrow: '你的初步形象分析',
      title: '具備風格方向，缺乏搭配結構',
      summary: '你對偏好的風格已有概念，但衣櫥與日常搭配尚未形成穩定系統。',
    ...
    low_energy_appearance: {
      ...
      eyebrow: '你的初步形象分析',
      title: '精神感與整體狀態落差',
      summary: '你目前最值得優先處理的，是使外觀更整潔、有精神和更具完整感。',
  ...
  scenes: [
    {
      ...
      caption: 'Martin 會先了解你如何看待目前的個人形象。',
      question: {
        id: 'q1',
        type: 'single',
        layout: 'scale',
