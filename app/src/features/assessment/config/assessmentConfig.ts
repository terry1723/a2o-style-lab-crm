...
export const assessmentConfig: AssessmentConfig = {
  ...
  opening: {
    headline: '你目前的形象，與你希望別人感受到的印象一致嗎？',
    supportingText: '由 Martin 親自透過四條簡單問題，了解你目前最值得改善的地方。',
    cta: '開始形象檢測',
  ...
  scenes: [
    ...
    },
    {
      ...
      question: {
        ...
        options: [
          { id: 'q2_a', label: '見客、銷售或洽談業務', value: 'client_sales', score: { professional_presence_gap: 3 } },
    ...
    },
    {
      ...
      question: {
        ...
        options: [
          ...
          { id: 'q3_f', label: '暫時未能明確說出，但知道形象需要改善', value: 'unsure', score: { low_energy_appearance: 2 } },
        ],
      },
    },
    {
      ...
      questionCueSeconds: 9999,
      idleMode: 'hold-last-frame',
      caption: '選擇最希望優先改善的一項，我們會從該部分開始分析。',
      question: {
        id: 'q4',
        type: 'single',
        title: '如果只能優先改善一個形象項目，你最想從哪裡開始？',
        options: [
          ...
          { id: 'q4_c', label: '身形比例與衣服剪裁', value: 'proportion', score: { untapped_image_potential: 2 } },
