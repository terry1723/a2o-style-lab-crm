    ...
    <main className="overflow-x-hidden bg-[#080808] font-sans text-[#f7f6f2] selection:bg-white selection:text-black">
      ...
      <section className="relative flex min-h-[88svh] items-center overflow-hidden border-b border-white/15 px-5 py-20 sm:px-8 lg:px-12">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl items-center gap-12 lg:grid-cols-[.86fr_1.14fr] lg:gap-16">
          ...
          <motion.figure initial="hidden" animate="visible" variants={rise} transition={{ duration: 0.65, delay: 0.08 }} className="relative overflow-hidden border border-white/20 bg-[#111]">
            <img src="/a2o/editorial/client-editorial-strip.png" alt="A2O Style Lab 客戶形象作品" className="w-full object-contain grayscale contrast-110" />
      ...
      <section aria-label="真實改變・看得見的影響力" className="border-b border-white/15 px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
        <div className="mx-auto max-w-7xl">
          ...
          <figure id="transformation-overview" className="mt-14 overflow-hidden border border-white/15 bg-[#111]"><img src="/a2o/editorial/transformation-collage.png" alt="A2O Style Lab 多個客戶的形象轉變" loading="lazy" className="w-full object-contain grayscale" /></figure>
        </div>
      </section>
      ...
      <section className="grid border-b border-white/15 lg:grid-cols-2"><figure className="min-h-[380px] bg-[#111]"><img src="/a2o/editorial/transformation-collage.png" alt="A2O Style Lab 為不同客戶設計的形象方向" loading="lazy" className="h-full w-full object-cover grayscale brightness-75" /></figure><div className="flex items-center bg-[#f7f6f2] px-6 py-16 text-black sm:px-12 lg:px-16"><Heading eyebrow="ABOUT A2O STYLE LAB" title="建立的不是一套造型，而是一套真正適合你的形象系統。" copy="透過髮型、比例、色彩、穿搭及整體風格，建立符合身份、工作與生活方式的個人形象。" /></div></section>
